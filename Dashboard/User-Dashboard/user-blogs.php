...
<html lang="en">
    ...
    <meta charset="UTF-8">
        ...
        <title> Blogs | User Dashboard</title>
    </head>
            ...
            <nav class="user-nav">
                <div class="user-logo-component">
                    ...
                    <div class="user-sidebar-component">
                        ...
                        <a href="./transfer-fund.php" class="user-nav__link "  title="Transfer Funds">
                        ...
                        <a href="./user-blogs.php" class="user-nav__link active" title="Blogs">
